...
| [`[monitors]`](/config/settings-reference/#monitors) | **Unreleased:** Optional ranking on current `main` that decides which connected display is Main, Secondary, and so on; not included in v0.6.10 |
